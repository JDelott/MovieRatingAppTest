import { Card, CardGroup, Grid, Form, Label } from "semantic-ui-react";
              ...
              {data.map((displayData: DisplayData) => (
                <Grid.Column key={displayData.id}>
                    <CardGroup>
                        ...
                        <Card style={{ height: 820 }} fluid image={`https://image.tmdb.org/t/p/original/${displayData.poster_path}`} 
                              header={
